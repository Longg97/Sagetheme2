        ...
        <div class="relative">
            <picture class="absolute w-full">
                <div class="flex flex-row w-[70%] mx-auto">
                    <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/dot-row.svg" alt="Banner">
                    <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/dot-row.svg" alt="Banner">                   
                </div>
            </picture>
            <div class="flex flex-row w-full gap-64">
                <div class="solution-item">
                    <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/spaceship.svg" alt="Banner">
                    <h3>
                ...
                <div class="solution-item">
                    <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/virus-red.svg" alt="Banner">
                    <h3>
                ...
                <div class="solution-item">
                    <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/store-line.svg" alt="Banner">
                    <h3>
