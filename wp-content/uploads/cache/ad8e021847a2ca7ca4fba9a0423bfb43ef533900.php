        ...
        <div class="w-[90%] mx-auto">
            ...
            <div class="relative">
                <picture class="absolute w-full">
                    <div class="flex flex-row w-[70%] mx-auto">
                        <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/dot-row.svg" alt="Dot-row">
                        <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/dot-row.svg" alt="Dot-row">                   
                    </div>
                </picture>
                <div class="flex flex-row w-full gap-64">
                    <div class="solution-item">
                        <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/spaceship.svg" alt="Space-ship">
                        <h3>
                        ...
                        <a href="/explore-orchestra" class="btn btn-text-primary m-0 desktop-white btn-ani">    
                            <span class="text">EXPLORE ORCHESTRA</span>
                            <span class="icomoon icon-chevron-right"></span>
                        </a>
                    </div>
                    <div class="solution-item">
                        <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/virus-red.svg" alt="Virus-red">
                        <h3>
                        ...
                        <a href="/explore-encompass-cloud" class="btn btn-text-primary m-0 desktop-white btn-ani">    
                            <span class="text">EXPLORE ENCOMPASS CLOUD</span>
                            <span class="icomoon icon-chevron-right"></span>
                        </a>
                    </div>
                    <div class="solution-item">
                        <img src="<?php echo TEMPLATE_ASSETS_URL; ?>/images/store-line.svg" alt="Store-line">
                        <h3>
                        ...
                        <a href="/explore-retail-solutions" class="btn btn-text-primary m-0 desktop-white btn-ani">    
